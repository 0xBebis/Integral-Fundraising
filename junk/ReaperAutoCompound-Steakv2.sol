 ...
 */
contract ReaperAutoCompoundSteakv2 is Ownable, Pausable {
    ...
    function _mapRewardToWFTMRoute(address _reward) internal returns (bool) {
     ...
     */
    function _chargeFees(address _reward, address _router) internal {
     ...
     */
    function _addLiquidity(address _lpPair, address _reward, address _router) internal {
    ...
    function _initializeBaseAllowances() internal returns (bool) {
      _giveAllowances(
        defaultRouter,
        defaultRewardToken,
        defaultLpPair,
    ...
    function _revokeBaseAllowances() internal returns (bool) {
      _removeAllowances(
        defaultRouter,
        defaultRewardToken,
        defaultLpPair,
